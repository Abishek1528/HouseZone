  ...
  return (
    <View style={adminStyles.dashboardContainer}>
      <ScrollView contentContainerStyle={adminStyles.dashboardContentContainer} style={{ width: '100%' }}>
        <Text style={adminStyles.dashboardTitle}>Machinery Tenant Submissions</Text>
        ...
        {loading ? (
          ...
          data.map((item) => (
            <View key={item?.tenantId || Math.random()} style={adminStyles.card}>
              ...
              <View style={adminStyles.cardSection}>
                <Text style={adminStyles.sectionTitle}>⚙️ Machinery Details</Text>
                {item?.propertyId ? (
                  <>
                    <View style={adminStyles.detailRow}>
                      <Text style={adminStyles.detailLabel}>Machinery ID:</Text>
                  ...
                  <Text style={adminStyles.noPropertyText}>No machinery associated</Text>
                )}
              </View>
            </View>
          ))
