  ...
  return (
    <View style={adminStyles.screen}>
      <AdminPageHeader
        ...
        subtitle="Review tenant submissions and open the linked commercial property"
      />
        ...
        {loading ? (
          ...
          data.map((item) => (
            <AdminTenantSubmissionCard
              ...
              propertySectionTitle="Business Property"
              propertyFields={[
                ...
                { label: "Facing:", value: item?.facingDirection },
